...
static int (*_select)(int nfds, fd_set *readfds,
...
static int (*_getpeername)(int socket, struct sockaddr *address,
                           socklen_t *address_len) = NULL;
static int (*_getsockname)(int socket, struct sockaddr *address,
                           socklen_t *address_len) = NULL;
